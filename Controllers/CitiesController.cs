...
{
    [Route("api/City/{action}", Name = "CitiesApi")]
    public class CitiesController : ApiController
    {
        ...
        public HttpResponseMessage Get(DataSourceLoadOptions loadOptions) {
            ...
            return Request.CreateResponse(DataSourceLoader.Load(city, loadOptions));
        }
        ...
        public HttpResponseMessage Put(FormDataCollection form) {
            ...
            var model = _context.City.FirstOrDefault(item => item.Id == key);
            if(model == null)
                return Request.CreateResponse(HttpStatusCode.Conflict, "City not found");
